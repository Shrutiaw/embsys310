...
control_user_led1
    LDR R2, = GPIOA_BASE              // load GPIOA_BASE to R2
    LDR R3,[R2, #GPIOA_ODR]           // load GPIOA_ODR+R2 to R3
  
    CMP R0,#1                         // compare R0 to 1
    ITE EQ                            //
 
    ORREQ R3,R3,#GPIOA_BIT_5          // turn ON LED1 by setting bit[5]=1
                                      //R2 |= GPIOA_BIT_5
 
    BICNE R3,R3,#GPIOA_BIT_5          // turn ONFF LED1 by setting bit[5]=0
                                      //R2 &=~ GPIOA_BIT_5
                                      
    STR R3,[R2,#GPIOA_ODR]            //load GPIOA_ODR+R2 to R3
 
    PUSH {LR}                         //store the LR
